        ...
        for (const c of colliders) {
            if (c != this && c.type != 'block') {
                ...
                if (intersections % 2) {
                    ...
                    game.match.map.debris.push(new Debris(allID++, c.x, c.y + (c.h / 2), { wind: false, w: 16, h: 12, z: c.z, color: '#ddddff', livetime: 12, alwaysDying: true, landable: true }))
                    game.match.map.debris.push(new Debris(allID++, c.x, c.y + (c.h / 2), { wind: false, w: 6, h: 6, xspeed: tempx, zspeed: 5 + tempz, z: c.z + c.hover, color: '#ddddff', livetime: 60, alwaysDying: true, landable: true }))    
                }
            }
        }
    }
